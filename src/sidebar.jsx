...
function Sidebar() {
  ...
  const getallthreads = async () => {
    try {
      const response = await fetch("http://ec2-51-20-86-67.eu-north-1.compute.amazonaws.com:3000/api/thread", {
    ...
    const getMessages = async () => {
      try {
        const response = await fetch(
          `http://ec2-51-20-86-67.eu-north-1.compute.amazonaws.com:3000/api/thread/${currthreadid}`,
          {
            credentials: "include", // Required for logged-in user!
          }
        );
  ...
  const deleteThread = async (threadId) => {
    try {
      const response = await fetch(
        `http://ec2-51-20-86-67.eu-north-1.compute.amazonaws.com:3000/api/thread/${threadId}`,
        {
          method: "DELETE",
          credentials: "include", // Required for logged-in user!
        }
